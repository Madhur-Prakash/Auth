...
@auth_doctor.post("/doctor/login_otp", status_code=status.HTTP_200_OK, response_class=HTMLResponse) # login using email 
...
@auth_doctor.get("/doctor/reset_password", status_code=status.HTTP_200_OK, response_class=HTMLResponse)
