...
#                     if not email_sent:
#                         raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail="Error sending email")
#                     return ({"request": request, "message": f"OTP sent successfully on {email_provided}", "status_code": status.HTTP_200_OK})
...
#                     if not otp:
#                         raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail="Error sending OTP")
#                     return ({"request": request, "message": f"OTP sent successfully on {phone_number_provided[3:7]+'x'*6+phone_number_provided[13:]}", "status_code": status.HTTP_200_OK,}) # masking the phone number for security
